...
public interface ISymbolicExecutor {
	...
	/**
	 * exposed to allow the inclusion of heuristics for prioritizing or avoiding the exploration of certain callers
	 * default uses no heuristics and simply returns all possible callers according to graph 
	 */
	 ...
	 * @return false if instr causes path to become infeasible or split; true otherwise
	 */

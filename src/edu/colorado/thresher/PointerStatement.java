...
public class PointerStatement implements Comparable {
	...
	public static enum EdgeType { Assign, GetField, PutField };
	...
	public PointerStatement(SSAInstruction instr, PointerVariable lhs, PointerVariable rhs, EdgeType type, String fieldName, int lineId, int lineNum) {
		this.instr = instr;
	...
	public SSAInstruction getInstr() { return instr; }
	...
	public int compareTo(Object other) {
		...
		if (this.getLineNum() < otherStmt.getLineNum()) return -1;
		else if (this.getLineNum() > otherStmt.getLineNum()) return 1;
		
		if (this.getLineId() < otherStmt.getLineId()) return -1;
		else if (this.getLineId() > otherStmt.getLineId()) return 1;
